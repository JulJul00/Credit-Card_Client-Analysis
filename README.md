...
An interactive PowerBI dashboard used to report and explore sales trends can be found here [Download the file here](https://github.com/JulJul00/Credit-Card_Client-Analysis/raw/main/ABC%20Inc..pbix).
